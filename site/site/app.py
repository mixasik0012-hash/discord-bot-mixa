...
welcome_roles TEXT DEFAULT '', leave_roles TEXT DEFAULT '',
logging_roles TEXT DEFAULT '', autorole_roles TEXT DEFAULT '',
levels_roles TEXT DEFAULT '', tempchannels_roles TEXT DEFAULT '',
